...
pub fn simulate_tend_flows() -> Vec<TendFlow> {
    vec![
        TendFlow {
            from_lat: -26.2,
            from_lon: 28.0,
            from_name: "Johannesburg".into(),
            to_lat: -33.9,
            to_lon: 18.4,
            to_name: "Cape Town".into(),
            amount_hours: 45.0,
            service_type: "CareWork".into(),
        },
        TendFlow {
            from_lat: -33.9,
            from_lon: 18.4,
            ...
            to_lat: -26.2,
            to_lon: 28.0,
            to_name: "Johannesburg".into(),
            amount_hours: 38.0,
            service_type: "Education".into(),
        },
        TendFlow {
            from_lat: 51.5,
            from_lon: -0.1,
            from_name: "London".into(),
            to_lat: 48.9,
            to_lon: 2.3,
            to_name: "Paris".into(),
            amount_hours: 22.0,
            service_type: "TechSupport".into(),
        },
        TendFlow {
            from_lat: 40.7,
            from_lon: -74.0,
            from_name: "New York".into(),
            to_lat: 34.0,
            to_lon: -118.2,
            to_name: "Los Angeles".into(),
            amount_hours: 31.0,
            service_type: "Creative".into(),
        },
        TendFlow {
            from_lat: -23.5,
            from_lon: -46.6,
            from_name: "São Paulo".into(),
            to_lat: -22.9,
            to_lon: -43.2,
            to_name: "Rio de Janeiro".into(),
            amount_hours: 28.0,
            service_type: "Wellness".into(),
        },
        TendFlow {
            from_lat: 35.7,
            from_lon: 139.7,
            from_name: "Tokyo".into(),
            to_lat: 37.6,
            to_lon: 127.0,
            to_name: "Seoul".into(),
            amount_hours: 19.0,
            service_type: "Gardening".into(),
        },
        TendFlow {
            from_lat: 19.4,
            from_lon: -99.1,
            from_name: "Mexico City".into(),
            to_lat: 4.7,
            to_lon: -74.1,
            to_name: "Bogotá".into(),
            amount_hours: 15.0,
            service_type: "HomeServices".into(),
        },
        TendFlow {
            from_lat: 6.5,
            from_lon: 3.4,
            from_name: "Lagos".into(),
            to_lat: 5.6,
            to_lon: -0.2,
            to_name: "Accra".into(),
            amount_hours: 12.0,
            service_type: "FoodServices".into(),
        },
    ]
}
...
mod tests {
    ...
    fn test_governance_pulses() {
        ...
        let ct = pulses
            .iter()
            .find(|p| p.name.contains("Cape Town"))
            .unwrap();
